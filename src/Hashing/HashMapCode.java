...
public class HashMapCode {
    static class HashMap<K,V> {  //generic
        private class Node  {
            ...
            private int n; //n - this will be total number of nodes
            private int N;
            private LinkedList <Node> buckets[]; //N - this will be the array of the linked list
            ...
            public void put(K key, V value) { // o(lambda) -> o(1)
                ...
                int di = searchInLinkedList(key, bi); //either we will get a valid index or -1
                if(di != -1) {
